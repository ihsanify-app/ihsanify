...
// Admin-initiated reset for a user who forgot their password. The admin
// picks the new password themselves (relayed to the user out-of-band, e.g.
// WhatsApp) rather than it being generated for them.
usersRouter.post(
